# Title: Set Gnome Extensions
# Description: Set up Gnome Extensions for a better desktop experience
...
if [ "$DISTRO" == "ubuntu" ] || [ "$DISTRO" == "debian" ]; then
    ...
    gum confirm "To install Gnome Extensions, you need to accept 4 confirmations. Are you ready?"
